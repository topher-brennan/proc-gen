...
pub const KE: f32 = 0.02;  // erosion rate fraction
pub const KD: f32 = 0.02;  // deposition rate fraction
...
// Prevents runaway erosion by capping slope used in capacity calc
// Note: the "slope" here is really a strem gradient, 5% is pretty steep
...
pub const MAX_FLOW: f32 = HEX_SIZE as f32;

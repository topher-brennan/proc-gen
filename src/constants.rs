...
pub const KC: f32 = HEX_SIZE * 0.10; // capacity coefficient
pub const KE: f32 = 0.001;  // erosion rate fraction
pub const KD: f32 = 0.001;  // deposition rate fraction
...
pub const WATER_THRESHOLD: f32 = HEX_SIZE * 0.001; // Feet
...
// Should MAX_FLOW be HEX_SIZE instead?
